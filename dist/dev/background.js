...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a
        .get("http://localhost:9000" + "/github/" + request.repoName + "/" + request.revision + "/json/" + request.file, {
